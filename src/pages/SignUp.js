    ...
    <div className='bg-neutral-800'>
      <section className=" dark:bg-gray-900 font-rajdhani">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="/welcome" className="flex items-center mb-6 text-2xl font-semibold text-neutral-100 dark:text-white">
                MyApp    
            </a>
            <div className="w-full bg-neutral-100 rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        ...
                        <button type="submit" className="w-full text-neutral-100 bg-neutral-800 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
